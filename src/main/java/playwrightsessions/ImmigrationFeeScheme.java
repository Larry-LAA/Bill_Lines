...
public class ImmigrationFeeScheme{
	public static void main(String[] args) {
		    try (Playwright playwright = Playwright.create()) {
		      ...
		      page.getByLabel("Username:").fill("a.fleming@bindmans.com");
		      page.getByLabel("Password:").click();
		      page.getByLabel("Password:").fill("Bindmans123");
		      ...
		      page1.locator("#searchCase_lscCaseReference").click();
		      page1.locator("#searchCase_lscCaseReference").fill("300001644513");
		      ...
		      //OpenCaseRefNumber
		      page1.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("300001644513")).click();
