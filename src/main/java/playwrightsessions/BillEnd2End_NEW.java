...
public class BillEnd2End_NEW{
	public static void main(String[] args) {
		    try (Playwright playwright = Playwright.create()) {
		      ...
		      page1.getByLabel("the Non Family HR bill line45").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line45").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line45").getByLabel("Fee Earner").fill("LG145");
		      page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Add")).click();
		      ...
		      page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Add")).click();
		      page1.getByLabel("the Non Family HR bill line201").getByLabel("Activity Date").click();
		      page1.getByLabel("the Non Family HR bill line201").getByLabel("Activity Date").fill("20/02/2024");
		      page1.getByLabel("the Non Family HR bill line201").getByLabel("Activity Type").selectOption("Attendance upon client (Time)");
		      page1.getByLabel("the Non Family HR bill line201").getByLabel("Activity Time (optional)").click();
		      page1.getByLabel("the Non Family HR bill line201").getByLabel("Activity Time (optional)").fill("01:00");
		      page1.getByLabel("the Non Family HR bill line201").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line201").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line201").getByLabel("Fee Earner").fill("LG201");
		      ...
		      page1.locator("#opmCtl0").fill("20/02/2024");
		      page1.locator("#opmCtl1").selectOption("Routine Telephone Call (Quantity)");
		      page1.locator("#opmCtl2").fill("01:00");
		      page1.locator("#opmCtl5").selectOption("20%");
		      page1.locator("#opmCtl6").fill("LG6");
		      page1.locator(".opa-row-add").click();
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG3");
		      
		      page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Add")).click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Activity Date").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Activity Date").fill("15/12/2023");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Activity Type").selectOption("Routine Telephone Call (Quantity)");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Amount of Items (optional)").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Amount of Items (optional)").fill("1");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG4");
		      
		      page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Add")).click();
		      page1.getByLabel("Activity Date").click();
		      page1.getByLabel("Activity Date").fill("15/12/2023");
		      page1.getByLabel("Activity Type").selectOption("Attendance upon client (Time)");
		      page1.getByLabel("Activity Time (optional)").click();
		      page1.getByLabel("Activity Time (optional)").fill("01:00");
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG5");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG6");
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG7");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG8");
		      //page1.locator(".opa-submit").click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG9");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG10");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG11");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG12");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG13");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG14");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG15");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG16");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG17");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG18");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG19");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG20");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG21");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG22");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG23");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG24");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG25");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG26");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG27");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG28");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG29");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG30");
		      page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG31");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG32");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG33");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG34");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG35");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG36");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG37");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG38");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG39");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG40");
		      page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG41");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG42");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG43");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG44");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG45");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG46");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG47");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG48");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG49");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG50");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG51");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG52");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG53");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG54");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG55");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG56");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG57");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG58");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG59");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG60");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG61");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG62");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG63");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG64");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG65");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG66");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG67");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG68");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG69");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG70");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG71");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG72");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG73");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG74");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG75");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG76");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG77");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG78");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG79");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG80");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG81");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG82");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG83");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG84");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG85");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG86");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG87");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG88");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG89");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG90");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG91");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG92");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG93");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG94");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG95");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG96");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG97");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG98");
		      page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG99");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG100");
		    ...
		    //Non Family Hourly Rate Bill Line
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG101");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG102");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG103");
		      ...
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").click();
		      page1.getByLabel("the Non Family HR bill line2").getByLabel("Fee Earner").fill("LG104");
		      //page1.locator(".opa-submit").click();
		      //page1.getByRole(AriaRole.BUTTON, new Page.GetByRoleOptions().setName("Next")).click();
		      ...
		      page1.getByLabel("VAT %").selectOption("20%");
		      page1.getByLabel("Fee Earner").click();
		      page1.getByLabel("Fee Earner").fill("LG105");

		      
		      //AssertConfirmationPageDisplayed
		      //Locator header = page1.locator("h1");
		     // assertThat(header).hasText("Confirmation");
		      
		      //AssertTotoalClaim
		      //Locator totalClaim = page1.locator("//div[text()='£85.49']");
		      //assertThat(totalClaim).containsText("£85.49");
		      
		      //ConfirmBill
		      page1.locator(".opa-submit").click();
		      
		      //BillSummaryPage
		      //Locator billSummaryPage = page1.getByRole(AriaRole.LINK, new Page.GetByRoleOptions().setName("Bill Summary"));
		      //assertThat(billSummaryPage).isVisible();		      
